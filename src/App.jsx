...
function App() {
  ...
  const getUsers = async () => {
    try {
      const res = await axios.get("https://provabackendimp-production.up.railway.app/api/person");
      setList(res.data);
  ...
  const registerUser = async () => {
    try { 
      await axios.post("https://provabackendimp-production.up.railway.app/api/person",{
  ...
  const deleteUser = async (id) => {
    try { 
      await axios.delete(`https://provabackendimp-production.up.railway.app/api/person/${id}`);
      getUsers()
    } catch (error) {
      console.error("Erro ao inserir", error);
    }
